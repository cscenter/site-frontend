          ...
          <div className="col-lg-12">
            <div className="grouped mb-4">
              <Checkbox
                ...
                label={
                  <>
                    Я обещаю самостоятельно выполнять все задания всех этапов поступления в ШАД и на совместные программы,
                    не списывать и не давать списывать,
                    не публиковать задания теста и экзамена в открытом доступе
                    во время наборной кампании с 19 марта по 1 августа 2025 года,
                    не использовать более одного логина для участия в отборе в ШАД и на совместные программы
                    <span className="asterisk">*</span>
                  </>
                }
                onChange={handleInputChange}
