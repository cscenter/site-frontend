      ...
      <>
        ...
        {isMftiAdvanced ? (
          <>
            ...
            <a href="mailto:education.sup@yandex.ru">education.sup@yandex.ru</a>.
            <br />
          ...
          <MemoizedTextField
            ...
            label={
              <>
                ...
                Это не формальность — мы внимательно изучаем все ответы. 
                Нам важно понять ваши настоящие цели, а не оценить красивое изложение текста. 
                Без объяснения мотивации мы решим, что поступление для вас не в приоритете
              ...
              <Checkbox
                ...
                label={
                  <>
                    ...
                    во время наборной кампании с 3 апреля по 1 августа 2025 года,
                    не использовать более одного логина для участия в отборе
                    <span className="asterisk">*</span>
                  </>
                }
                onChange={handleInputChange}
            ...
            <div className="grouped mb-4">
              <Checkbox
                ...
                label='Я согласен (-на) на получение новостной и рекламной рассылки от
                        АНО ДПО «Образовательные технологии Яндекса» (ОГРН 1147799006123) 
                        и ООО «ЯНДЕКС» (ОГРН 1027700229193)'
                onChange={handleInputChange}
              />
            </div>
          </div>
