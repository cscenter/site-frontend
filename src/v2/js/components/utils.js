 ...
 */
function onFilterChange({ applyPatches = null, setStateCallback = undefined } = {}, name, value) {
  this.setState(state => {
 ...
 */
export function onSearchInputChange(value, name, { applyPatch = null } = {}) {
  this.setState(state => {
    const patch = {
      [name]: value
    };
 ...
 */
export function onInputChange(event, { applyPatches = null, setStateCallback = undefined } = {}) {
...
export function onSelectChange(
  option,
  name,
  { applyPatch = null, setStateCallback = undefined } = {}
) {
  this.setState(state => {
    const patch = {
      [name]: option
